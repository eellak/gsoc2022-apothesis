...
//============================================================================
#ifndef ADSORPTIONPSEUDO2SITES_H
#define ADSORPTIONPSEUDO2SITES_H
...
class AdsorptionPseudo2Sites: public Process
{
public:
    AdsorptionPseudo2Sites();
    ~AdsorptionPseudo2Sites() override;
...
private:
    ...
    ///The mole fraction of the AdsorptionPseudo2Sites process
    double m_dMolFrac;
    ...
    REGISTER_PROCESS(AdsorptionPseudo2Sites)
};
}

#endif // AdsorptionPseudo2Sites_H
