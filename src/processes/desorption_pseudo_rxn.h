...
//============================================================================
#ifndef DESORPTIONPSEUDORXN_H
#define DESORPTIONPSEUDORXN_H
...
class DesorptionPseudoRxn:public Process
{
public:
    DesorptionPseudoRxn();
    ~DesorptionPseudoRxn() override;
...
private:
    ...
    REGISTER_PROCESS( DesorptionPseudoRxn )
};
}

#endif // DesorptionPseudoRxnSIMPLECUBIC_H
